...
public enum AuditAction {
    ...
    SVWS_INSTANZ_SCHEMA_SYNC,
    SVWS_INSTANZ_SCHEMA_FUNDE_LIST,
    SVWS_SCHEMA_FUND_ZUORDNEN,
    SVWS_SCHEMA_FUND_SCHULINFO,
    SCHEMA_CREATE,
    SCHEMA_UPDATE,
    SCHEMA_DEACTIVATE,
    SCHEMA_DESTROY,
    ...
    SCHULDATEI_IMPORT,
    SCHULDATEI_STATUS,
    SCHULDATEI_SCHULEN_LIST,
    SCHULDATEI_SCHULTRAEGER_LIST
}
